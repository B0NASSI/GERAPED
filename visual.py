...
def _fonte_ajustada(draw, texto, caminho_fonte, tamanho_inicial, largura_maxima, tamanho_minimo=10):
...
def gerar_banner(
    ...
    ImageDraw.Draw(blob).ellipse(
        ...
        fill=(*_hex_para_rgb(cor_destaque), 45),
    )
